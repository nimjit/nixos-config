...
#+begin_src emacs-lisp
  ...
  ;; Daemon: set-face-attribute with nil frame only applies to the initial frame.
  ;; This hook applies the font to every new client frame.
  (add-hook 'after-make-frame-functions
    (lambda (frame)
      (set-face-attribute 'default frame :font "CMU Typewriter Text-16")))
#+end_src

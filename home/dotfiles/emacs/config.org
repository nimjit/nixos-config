        ...
        (while (not (eobp))
          (let ((line (buffer-substring-no-properties
            ...
            (cond
             ...
             ((and in-section (string-match "^# " line) (not (string-match "^# Planning" line))) (setq in-section nil))
    ...
    (with-current-buffer buf
      (let ((inhibit-read-only t))
        ...
        (cl-flet ((section (header)
          ...
          (insert (propertize
                   "  d daily   w weight   f files   g refresh   q close\n"
                   'face 'shadow))))
      ...
      (when (fboundp 'evil-define-key*)
        (dolist (b '(("q" . bury-buffer)
                     ...
                     ("w" . my/dash-log-weight)
                     ("RET" . push-button)))
          (evil-define-key* 'normal (current-local-map) (kbd (car b)) (cdr b))
          (evil-define-key* 'motion (current-local-map) (kbd (car b)) (cdr b)))))

...
-- ctrl+shift+hjkl: jump directly to kitty split (mirrors kitty terminal behaviour)
vim.keymap.set('n', '<C-S-h>', function() vim.fn.system('kitty @ focus-window --match neighbor:left   2>/dev/null') end, { silent = true })
